...
TIP: For more information about Astra Trident architecture on the Kubernetes cluster, refer to link:../trident-get-started/architecture.html[Astra Trident architecture].
